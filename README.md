...
`R11` is active through `R11-007` only. Its cycle ledger/state machine definition, thin cycle controller CLI, bounded bootstrap/resume-from-repo-truth packets, local-only residue guard, bounded Dev dispatch/result packet adapter, separate QA gate contracts/tooling, and status surfaces are backed by:
- `governance/R11_CONTROLLED_EXTERNAL_CYCLE_CONTROLLER_AND_REPO_TRUTH_RESUME_PILOT.md`
- `governance/reports/AIOffice_V2_R10_Audit_and_R11_Planning_Report_v1.md`
