...
`R13 API-First QA Pipeline and Operator Control-Room Product Slice` is now active in repo truth through `R13-008` only.
...
All R13 gates are planned and not yet fully delivered at `R13-008`.
