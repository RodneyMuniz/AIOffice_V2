...
`R13 API-First QA Pipeline and Operator Control-Room Product Slice` is now active in repo truth through `R13-012` only.
...
R13 gates remain conservative at `R13-012`.
