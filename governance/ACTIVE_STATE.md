...
- `R6-P1` and `R6-P2` are the immediate R6 preconditions recorded before later pilot tasks depend operationally on final-head closeout support evidence or baton path behavior.
