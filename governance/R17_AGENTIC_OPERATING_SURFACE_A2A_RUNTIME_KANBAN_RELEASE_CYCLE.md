...
**Status after this pass:** Active through `R17-028` final package only; closeout candidate, operator decision required.
...
**Closeout-candidate boundary:** `R17-028` is the final reporting and planning package only. R17 is not closed without explicit operator approval. R18 is not opened.
