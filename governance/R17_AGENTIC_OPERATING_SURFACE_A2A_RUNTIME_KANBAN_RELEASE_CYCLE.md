...
These cycles are not working yet and are not claimed by `R17-001` through `R17-017`.
...
This R17 active boundary through `R17-017` claims none of the following:
...
- no R17-018 or later implementation yet;
...
- R17-018 through R17-028 are implemented by this pass;
