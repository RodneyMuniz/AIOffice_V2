...
## Purpose
This index maps the completed bounded R4 state to the exact governing docs, implementation modules, focused tests, proof entrypoints, proof-review artifacts, milestone commits, and exclusions that an independent audit should preserve. It is an audit-readiness surface only and not a next-phase planning record.
