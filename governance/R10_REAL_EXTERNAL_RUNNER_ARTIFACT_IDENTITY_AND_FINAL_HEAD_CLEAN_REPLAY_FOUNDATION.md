...
Opening R10 does not implement external runner proof.

Opening R10 does not prove real CI.

Opening R10 does not prove external QA.

Opening R10 does not prove solved Codex context compaction.

Opening R10 does not prove unattended automatic resume.

Opening R10 does not prove hours-long unattended milestone execution.

Opening R10 does not prove broad autonomous milestone execution.
...
- `R10-002` is the next gated step. It must harden the closeout-facing external-runner identity contract without treating unavailable runner state as proof.
- `R10-003` must define the bundle shape before a runner result can be accepted as closeout evidence.
