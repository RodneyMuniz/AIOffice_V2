...
Assert-Condition -Condition ($authority -like "*R18-020*R18-028*planned only*") -Message "R18 authority must state R18-020 through R18-028 planned only."
...
Write-Output "R18 opening authority state remains active through R18-001 only; current status is active through R18-019 only with R18-020 through R18-028 planned only."
