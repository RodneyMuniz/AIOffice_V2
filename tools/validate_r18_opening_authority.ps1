...
Assert-Condition -Condition ($authority -like "*Active through*R18-021*agent invocation and tool-call evidence model foundation only*") -Message "R18 authority must state active through R18-021 only."
Assert-Condition -Condition ($authority -like "*R18-022*R18-028*planned only*") -Message "R18 authority must state R18-022 through R18-028 planned only."
...
Write-Output "R18 opening authority state remains active through R18-001 only; current status is active through R18-021 only with R18-022 through R18-028 planned only."
