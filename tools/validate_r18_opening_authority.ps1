...
Assert-Condition -Condition ($authority -like "*Active through*R18-020*board/card runtime event model foundation only*") -Message "R18 authority must state active through R18-020 only."
Assert-Condition -Condition ($authority -like "*R18-021*R18-028*planned only*") -Message "R18 authority must state R18-021 through R18-028 planned only."
...
Write-Output "R18 opening authority state remains active through R18-001 only; current status is active through R18-020 only with R18-021 through R18-028 planned only."
