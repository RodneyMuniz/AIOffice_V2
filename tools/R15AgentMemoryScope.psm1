...
function Assert-R15MemoryScopeStatusPosture {
    ...
    Assert-NoForbiddenPositiveClaim -Text $combinedText -Context "R15-005 status docs" -ClaimLabel "R15-008 or later completion" -Pattern '(?i)\bR15-00[8-9]\b.{0,140}\b(done|complete|completed|implemented|executed|ran)\b'
