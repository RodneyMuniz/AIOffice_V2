...
try {
    ...
    Invoke-ExpectedRefusal -Label "r16-020-implementation-overclaim" -RequiredFragments @("R16-020 or later implementation") -Action {
        $scenario = New-StatusDocHarness -Root (Join-Path $tempRoot "invalid-r16-020-implementation")
        Add-Content -LiteralPath $scenario.R16AuthorityPath -Value ($crlf + "R16-020 implementation is complete.") -Encoding UTF8
        & $testStatusDocGate -RepositoryRoot $scenario.Root | Out-Null
    }
    ...
    Invoke-ExpectedRefusal -Label "r16-handoff-packet-overclaim" -RequiredFragments @("handoff packet implementation") -Action {
