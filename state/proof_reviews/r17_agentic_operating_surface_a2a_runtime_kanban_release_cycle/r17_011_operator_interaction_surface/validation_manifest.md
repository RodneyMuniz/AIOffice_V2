...
The requested validation sweep passed after dependency artifact churn was restored to exact HEAD blobs and verified clean.
...
- powershell -NoProfile -ExecutionPolicy Bypass -File tools/new_r17_operator_intake_surface.ps1
...
## Focused Post-Manifest Commands
