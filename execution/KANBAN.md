...
- Done when: closeout is rejected from committed evidence, the four partial gates remain partial, no two-phase final-head support runs, R13 is not closed, R13-018 remains planned only, and no R14 is opened
